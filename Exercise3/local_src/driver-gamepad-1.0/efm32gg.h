...
#define GPIO_PA_LENGTH 0x24
#define GPIO_PB_BASE 0x40006024
#define GPIO_PB_LENGTH 0x24
...
#define EXTIPSELL_OFFSET    0x100
#define EXTIFALL_OFFSET     0x10c
#define IEN_OFFSET          0x110
#define IF_OFFSET           0x114
#define IFC_OFFSET          0x11c
